    ...
    <section className="bg-dark py-20" id="about">
      <div className="md:flex items-center justify-between lg:mx-16 mx-5 lg:gap-20 gap-8">
        <div className="bg-darkgrey p-5">
          ...
          <h2 className="font-semibold text-5xl mt-2 text-left text-white font-montserrat">
            Leonardo Gunawan
          </h2>
        </div>
        <div className="w-full lg:w-2/3 text-xl lg:text-3xl text-white text-center md:text-left font-normal mt-5 font-montserrat">
